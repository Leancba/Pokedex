...
const Pokemons = props => {
  ...
  const fetchPokemons = () => {
    fetch('https://pokeapi.co/api/v2/pokemon?limit=101&offset=151')
              ...
              return (
                ...
                <TouchableOpacity
                  ...
                  <Image
                    style= {styles.image2}
                    source={{
                      uri: `https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/${index+152}.png`,
                    }}
                  />
